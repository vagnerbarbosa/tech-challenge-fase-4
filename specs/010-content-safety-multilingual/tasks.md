...
**Input**: Design documents from `/specs/010-content-safety-multilingual/`  
**Prerequisites**: plan.md, spec.md  
**Branch**: `010-content-safety-multilingual`  
...
- [X] T059 [P] Criar `specs/010-content-safety-multilingual/spec.md`
- [X] T060 [P] Criar `specs/010-content-safety-multilingual/tasks.md`
