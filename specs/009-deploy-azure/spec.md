...
- **Q**: Qual será a URL do serviço?  
  **A**: IP público atribuído dinamicamente pelo Azure Container Instances: `http://20.201.82.8:8000`
...
- **SC-001**: Aplicação acessível via IP público ✅
  - URL: http://20.201.82.8:8000
- **SC-002**: Swagger disponível em /docs ✅
  - http://20.201.82.8:8000/docs
...
| Endpoint | URL |
|----------|-----|
| API Base | http://20.201.82.8:8000 |
| Health | http://20.201.82.8:8000/health |
| Swagger | http://20.201.82.8:8000/docs |
| ReDoc | http://20.201.82.8:8000/redoc |
