...
- Use o OpenAPI JSON: `http://20.226.206.126:8000/openapi.json`
...
Você precisará de:
- **URL da API**: fornecida pelo administrador (ex: `http://20.226.206.126:8000`)
...
API_URL="http://20.226.206.126:8000"
...
curl -H "X-API-Key: sua-api-key" \
  "http://20.226.206.126:8000/openapi.json" > openapi.json
```
...
3. **Configure o Environment:**
   - `base_url`: `http://20.226.206.126:8000`
   - `api_key`: sua-api-key
...
const API_URL = "http://20.226.206.126:8000"
